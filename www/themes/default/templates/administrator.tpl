...
{if (isset($T_CTG) && $T_CTG == 'faculties')}
    {assign var = "title" value = $title|cat:'&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="'|cat:$smarty.server.PHP_SELF|cat:'?ctg=faculties">'|cat:$smarty.const._FACULTIES|cat:'</a>'}
    {if $smarty.get.edit_faculties}
        {assign var = "title" value = $title|cat:'&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "'|cat:$smarty.server.PHP_SELF|cat:'?ctg=faculties&edit_faculties='|cat:$smarty.get.edit_faculties|cat:'">'|cat:$smarty.const._EDITFACULTIES|cat:' <span class = "innerTableName">&quot;'|cat:$T_FACULTIES_NAME|cat:'&quot;</span></a>'}
    {elseif $smarty.get.add_faculties}
        {assign var = "title" value = $title|cat:'&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "'|cat:$smarty.server.PHP_SELF|cat:'?ctg=faculties&add_faculties=1">'|cat:$smarty.const._NEWFACULTIES|cat:'</a>'}
    {/if}
