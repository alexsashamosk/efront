...
{capture name = "moduleControlPanel"}
	...
	{if !in_array('moduleFacultiesList', $T_POSITIONS) && $smarty.capture.moduleFacultiesList}
	                    <li id="secondlist_moduleFacultiesList">
	                        <table class = "singleColumnData">
	                            {$smarty.capture.moduleFacultiesList}
	                        </table>
	                    </li>
	{/if}
	
	{if !in_array('moduleDepartmentsList', $T_POSITIONS) && $smarty.capture.moduleDepartmentsList}
	                    <li id="secondlist_moduleDepartmentsList">
	                        <table class = "singleColumnData">
	                            {$smarty.capture.moduleDepartmentsList}
	                        </table>
	                    </li>
	{/if}
