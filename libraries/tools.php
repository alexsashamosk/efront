...
function eF_getMenu()
{
    ...
    switch($_SESSION['s_type']) {
        case 'administrator':
			...
			$menu['general']['departments']   = array('title' => _DEPARTMENTS,   'link' => 'administrator.php?ctg=departments',       'image' => 'departments');
            $menu['general']['faculties']   = array('title' => _FACULTIES,   'link' => 'administrator.php?ctg=faculties',       'image' => 'faculties');
